							...
							echo "<div class=\"btn-group pull-right\">\n";
								...
								// Otherwise, offer to close
									...
									if ((isset($_SESSION["close_risks"]) && $_SESSION["close_risks"] == 1)) 
										{ echo "<li><a class='close-risk' href=\"close.php?id=".$escaper->escapeHtml($id)."\">". $escaper->escapeHtml($lang['CloseRisk']) ."</a></li>\n";									}
								}
	                    ...
	                    echo "<form name=\"details\" method=\"post\" action=\"\">";
	                        echo "<div class=\"edit-subject row-fluid\">";
	                            ...
	                            echo "<div class=\"span3\">";
	                            	if (isset($_SESSION['general']) && $_SESSION['general'] == 1){
		                                echo "<a href=\"/dashboard/view.php?id=" . $escaper->escapeHtml($id) . "&type=0\" class=\"btn cancel-edit-subject \" style=\"margin:0 5px 0 0;\" >Cancel</a>";
	                            	}else{
...
function edit_risk_details($id, $submission_date,$submitted_by, $subject, $reference_id, $regulation, $control_number, $location, $source, $category, $team, $additional_stakeholders, $technology, $owner, $manager, $assessment, $notes, $scoring_method, $CLASSIC_likelihood, $CLASSIC_impact, $AccessVector, $AccessComplexity, $Authentication, $ConfImpact, $IntegImpact, $AvailImpact, $Exploitability, $RemediationLevel, $ReportConfidence, $CollateralDamagePotential, $TargetDistribution, $ConfidentialityRequirement, $IntegrityRequirement, $AvailabilityRequirement, $DREADDamagePotential, $DREADReproducibility, $DREADExploitability, $DREADAffectedUsers, $DREADDiscoverability, $OWASPSkillLevel, $OWASPMotive, $OWASPOpportunity, $OWASPSize, $OWASPEaseOfDiscovery, $OWASPEaseOfExploit, $OWASPAwareness, $OWASPIntrusionDetection, $OWASPLossOfConfidentiality, $OWASPLossOfIntegrity, $OWASPLossOfAvailability, $OWASPLossOfAccountability, $OWASPFinancialDamage, $OWASPReputationDamage, $OWASPNonCompliance, $OWASPPrivacyViolation, $custom)
{
	...
	echo "<h4>". $escaper->escapeHtml($lang['Details']) ."</h4>\n";
        echo "<div class=\"tabs--action\">";
    if (isset($_SESSION['general']) && $_SESSION['general'] == 1){
    	echo "<a href='/dashboard/view.php?id=$id&type=0' id=\"cancel_disable\" class=\"btn cancel-edit-details on-edit\">". $escaper->escapeHtml($lang['Cancel']) ."</a>\n";
    }else{
...
*************************************/
function view_mitigation_details($risk_id, $mitigation_date, $planning_strategy, $mitigation_effort, $mitigation_cost, $mitigation_owner, $mitigation_team, $current_solution, $security_requirements, $security_recommendations, $planning_date, $mitigation_percent, $general = false)
{
	global $lang;
	global $escaper;
    ...
    if (basename($_SERVER['PHP_SELF']) == "view.php" && $general == false)
	{
...
*************************************/
function edit_mitigation_details($risk_id, $mitigation_date, $planning_strategy, $mitigation_effort, $mitigation_cost, $mitigation_owner, $mitigation_team,  $current_solution, $security_requirements, $security_recommendations, $planning_date, $mitigation_percent)
{
	global $lang;
	global $escaper;
	// Decrypt fields
	    ...
	    <div class=\"row-fluid\">
	        <div class=\"span5\">
	            ...
	            <div class=\"row-fluid\">
	                ...
	                <div class=\"span7\">";
	                    echo "<input type=\"number\" min=\"0\" max=\"100\" name=\"mitigation_percent\"  size=\"50\" value=\"" . $escaper->escapeHtml($mitigation_percent) . "\" class='percent active-textfield' />";
	                echo "</div>
	            </div>
	        </div>
	        <div class=\"span5\">
...
*********************************/
function view_review_details($id, $review_date, $reviewer, $review, $next_step, $next_review, $comments, $general = false)
{
	global $lang;
	global $escaper;
								...
								***************************/
								function view_top_menu($active)
								{
									...
									echo "<div class=\"container-fluid\">\n";
                                                                                echo "<a class=\"brand\" href=\"/\"><img src='images/logo@2x.png' alt='SimpleRisk Logo' /></a>\n";
									...
									else
									{
                                        ...
                                        //If general user
										if (isset($_SESSION["general"]) && $_SESSION["general"] == '1'){
											echo ($active == "Dashboard" ? "<li class=\"active\">\n" : "<li>\n");
											echo "<a href=\"../dashboard/index.php\">" . $escaper->escapeHtml($lang['Dashboard']) . "</a>\n";
											echo "</li>\n";
											echo ($active == "SubmitRisk" ? "<li class=\"active\">\n" : "<li>\n");
											echo "<a href=\"../dashboard/submit.php\">" . $escaper->escapeHtml($lang['SubmitRisk']) . "</a>\n";
											echo "</li>\n";
											echo "</div>\n";	
										}else{
