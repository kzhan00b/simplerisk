  ...
  function generalAddRisk($this){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#show-alert').html(message);
                    if (message[0].innerText == 'The subject of a risk cannot be empty.'){
                        return; //If subject empty, prevent redirect
                    }

                    setTimeout(function(){
                        window.onbeforeunload = null;
                        window.location = './index.php'; //After submit, redirect to general dashboard
                    }, 2000);
                },
                error: function(){
...
//    temp()
    ...
    $('#tab-content-container').delegate('.gsave-risk-form', 'click', function(){
        generalAddRisk($(this));
    })
