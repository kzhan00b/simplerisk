...
if (isset($_GET['id']))
{
  ...
  // Check if this risk belongs to the user
  if (!check_risk_belongs($id)){
    set_alert(true, "bad", "You can not view this risk.");
    header("Location: ./index.php");
    exit();
  }

  // Allow the user to update the risk
  $access = true;

  // If the classic risk was updated
  if (isset($_POST['update_classic']) && $access)
  {
  ...
  // If the cvss risk was updated
  else if (isset($_POST['update_cvss']) && $access)
  {
  ...
  // If the dread risk was updated
  else if (isset($_POST['update_dread']) && $access)
  {
  ...
  // If the owasp risk was updated
  else if (isset($_POST['update_owasp']) && $access)
  {
  ...
  // If the custom risk was updated 
  else if (isset($_POST['update_custom']) && $access)
  {
...
if (isset($_POST['update_subject']) && $access)
{
  $id = $_POST['riskid'];
