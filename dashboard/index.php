  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="row-fluid">
          <div class="span7">
            <div class="well">
              ...
              if (isset($_SESSION['uid'])){
                $open = get_open_risks($_SESSION['uid']);  
                $high = get_high_risks($_SESSION['uid']);
                $veryhigh = get_veryhigh_risks($_SESSION['uid']);
              }
          ...
          <div class="span5">
            <div class="well">
              <?php 
                if (isset($_SESSION['uid'])){
                  open_risk_level_pie($escaper->escapeHtml($lang['RiskLevel']), $_SESSION['uid']); 
                }
              ?>
            </div>
          </div>
        ...
        <?php 
          if (isset($_SESSION['uid'])){
            get_risk_table(23, "", $_SESSION['uid']); 
          }?>
      </div>
    </div>
  </div>
